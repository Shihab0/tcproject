  ...
  return (
    <div className="">
      ...
      <div className="mt-12 bg-green-950 p-7 px-10 rounded-md flex flex-col md:flex-row justify-center gap-3 md:justify-between">
        <div className="flex text-center md:text-left flex-col md:flex-row items-center gap-2">
        ...
        <div className="flex md:text-left flex-col md:flex-row text-center items-center gap-3">
